...
**Versión actual:** `v0.10.2` — *2026-03-30* ⚡
...
|---------|-------|---------------------|
| `0.10.2` | 2026-03-30 | **Streaming + rendimiento:** chat token a token, timeout/cancelacion robusta, pipeline unificado sin redundancias, offload a threadpool para evitar cuelgues |
