...
CATALOG: list[AbliteratedModel] = [
    ...
    AbliteratedModel(
        name="huihui_ai/llama3.2-abliterated:3b",
        display_name="Llama 3.2 3B Abliterado (Ollama)",
        source=SOURCE_OLLAMA,
        params_b=3.0,
        size_gb=2.1,
        vram_min_gb=4.0,
        tags=["llama", "equilibrado", "chat"],
        description="Alternativa compacta de la familia Llama para equipos modestos.",
    ),
    AbliteratedModel(
        name="huihui_ai/llama3.1-abliterated:8b",
        display_name="Llama 3.1 8B Abliterado (Ollama)",
        source=SOURCE_OLLAMA,
        params_b=8.0,
        size_gb=5.2,
        vram_min_gb=8.0,
        tags=["llama", "popular", "chat"],
        description="Modelo 8B versátil para chat y tareas generales con buena calidad.",
    ),
    AbliteratedModel(
        name="huihui_ai/qwen2.5-coder-abliterate:7b",
        display_name="Qwen2.5 Coder 7B Abliterado (Ollama)",
        source=SOURCE_OLLAMA,
        params_b=7.0,
        size_gb=4.6,
        vram_min_gb=8.0,
        tags=["código", "desarrollo", "agente"],
        description="Variante coder más capaz para refactors y tareas de ingeniería de software.",
    ),
    AbliteratedModel(
        name="huihui_ai/deepseek-r1-abliterated:8b",
        display_name="DeepSeek R1 8B Abliterado (Ollama)",
        source=SOURCE_OLLAMA,
        params_b=8.0,
        size_gb=5.5,
        vram_min_gb=9.0,
        tags=["razonamiento", "nuevo", "gpu"],
        description="Modelo enfocado en razonamiento profundo para tareas de análisis.",
    ),
    # ── Grandes (8GB+ VRAM) ───────────────────────────────────────────────────
    AbliteratedModel(
    ...
    AbliteratedModel(
        name="mlabonne/NeuralDaredevil-14B-abliterated",
        display_name="NeuralDaredevil 14B Abliterado (HF)",
        source=SOURCE_HUGGINGFACE,
        params_b=14.0,
        size_gb=28.0,
        vram_min_gb=16.0,
        tags=["llama", "alto rendimiento", "f16"],
        description="Escala superior para mayor calidad en generación y seguimiento de contexto largo.",
        hf_url="https://huggingface.co/mlabonne/NeuralDaredevil-14B-abliterated",
    ),
    AbliteratedModel(
        name="huihui-ai/Huihui-Qwen3.5-32B-abliterated",
        display_name="Qwen3.5 32B Abliterado (HF)",
        source=SOURCE_HUGGINGFACE,
        params_b=32.0,
        size_gb=65.0,
        vram_min_gb=28.0,
        tags=["muy potente", "qwen", "producción"],
        description="Perfil de alta capacidad para servidores GPU con contexto extenso.",
        hf_url="https://huggingface.co/huihui-ai/Huihui-Qwen3.5-32B-abliterated",
    ),
]
